...
export default class HighLevelEncoder {
   ...
   * @return the encoded message (the char values range from 0 to 255)
   */
  public static encodeHighLevel(msg: string,
                                shape: SymbolShapeHint,
                                minSize: Dimension,
                                maxSize: Dimension): string {
  ...
  static lookAheadTest(msg: /*CharSequence*/string, startpos: int, currentMode: int): int {
   ...
   */
  public static determineConsecutiveDigitCount(msg: /*CharSequence*/string, startpos: int): int {
    let count: int = 0;
