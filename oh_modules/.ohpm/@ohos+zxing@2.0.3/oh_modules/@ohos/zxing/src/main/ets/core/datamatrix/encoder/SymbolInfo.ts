...
export default class SymbolInfo {
  ...
  public static newSymbolInfo(rectangular: boolean, dataCapacity: int, errorCodewords: int,
                              matrixWidth: int, matrixHeight: int, dataRegions: int) {
    return new SymbolInfo(rectangular, dataCapacity, errorCodewords, matrixWidth, matrixHeight, dataRegions,
      dataCapacity, errorCodewords);
  }

  constructor(rectangular: boolean, dataCapacity: int, errorCodewords: int,
              matrixWidth: int, matrixHeight: int, dataRegions: int,
              rsBlockData: int, rsBlockError: int) {
  ...
  public static lookup(dataCodewords: int,
                       shape: SymbolShapeHint,
                       minSize: Dimension,
                       maxSize: Dimension,
                       fail: boolean): SymbolInfo {
